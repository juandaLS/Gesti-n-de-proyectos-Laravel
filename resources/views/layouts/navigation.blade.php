    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                @can('create', App\Models\Vacante::class)        
                    <p class="mr-3 text-sm text-gray-500">
                    @choice('Notificacion|Notificaciones', Auth::user()->unreadNotifications->count())    
                    </p> 
                    <a class="mr-3 w-7 h-7 bg-teal-800 hover:bg-gray-800 rounded-full flex flex-col justify-center items-center text-sm fount-extrabold text-white" href="{{route('notificaciones')}}">
